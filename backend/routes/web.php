...
$serveLatestBundleFile = function (string $file) {
    $allowed = [
        ...
        'equipment_sets.json',
        'equipment_star_module_v1.json',
        'equip_slots_v1.json',
        'equipment_growth_rules_v1.json',
        'character_growth_rules_v1.json',
        'progression_milestones_v1.json',
        'blue_equipment_templates_v1.json',
        'blue_affixes_v1.json',
        'purple_affix_pool_v1.json',
        'gem_catalog_v1.json',
        'talisman_module_v1.json',
        'boss_core_module_v1.json',
...
Route::get('/equipment_star_module_v1.json', function () {
    $path = storage_path('app/exports/equipment_star_module_v1.json');
    abort_unless(File::exists($path), 404);
    return response(File::get($path), 200, [
        'Content-Type' => 'application/json; charset=utf-8',
        'Cache-Control' => 'no-cache',
...
Route::get('/blue_equipment_templates_v1.json', function () {
...
Route::get('/blue_affixes_v1.json', function () {
...
Route::get('/talisman_module_v1.json', function () {
    $path = storage_path('app/exports/talisman_module_v1.json');
    abort_unless(File::exists($path), 404);
    return response(File::get($path), 200, [
        'Content-Type' => 'application/json; charset=utf-8',
        'Cache-Control' => 'no-cache',
...
Route::get('/boss_core_module_v1.json', function () {
